...
export default function DarkModeToggle({ className, darkClassName }) {
        ...
        return (
            <svg
                className={`cursor-pointer inline fill-deep-sky-blue mx-2 ${
                    className ? className : "w-[45px] h-[43px]"
                }`}
    ...
    return (
        <svg
            className={`cursor-pointer inline fill-deep-sky-blue mx-2 ${
                darkClassName ? darkClassName : "w-[32px] h-[41px]"
            }`}
            onClick={toggleDarkMode}
            viewBox="0 0 32 41"
            fill="none"
