  ...
  return (
    <div className="flex flex-col">
      <header className="flex items-center justify-end xs:pb-10 mxs:justify-between mxs:px-5 gap-20">
        ...
        <div className="flex justify-center  gap-10 items-center font-bold text-[#7D7D7D] text-24px ">
          <Link href="/scrapbook"><p className="hover:text-orange-peel transition-all cursor-pointer">SCRAPBOOK</p></Link>
          <Link href="/project-gallery"><p className="hover:text-orange-peel transition-all cursor-pointer">PROJECTS</p></Link>
          <Link href="/"><p className="hover:text-orange-peel transition-all cursor-pointer">PEOPLE</p></Link>
          <Link href="/"><p className="hover:text-orange-peel transition-all cursor-pointer">JOBS</p></Link>
        </div>
