...
export default function NotificationsLink({ unread, className }) {
  return (
    <Link href="/app/notifications">
      <div className="inline relative md:mt-[.2rem]">
        ...
        {unread && <span className="absolute bg-[#FF9800] md:h-2 md:w-2 w-[.4rem] h-[.4rem] rounded-full md:top-[-0.2rem] top-[.05rem] right-[.8rem]" />}        
      </div>
    </Link>
  );
}
