...
const TopNav = ({ unread }) => {
    ...
    return (
        ...
        {
            openNavbar ? <div className="w-[100%] text-[14px] px-4 mt-[6rem] flex flex-col gap-3 absolute bg-white z-10 pb-5 transition duration-150 ease-out">
                <button className="w-[max-content] justify-self-end self-end" onClick={closeNavbarHandler}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3">
    ...
    border: "1.5px solid #F8FBFF"
          ...
          <>
                    <Link href="/index">
                        <div
                            className={
                                router.pathname === "/app" ? "text-orange-peel flex items-center" : "cursor-pointer hover:text-orange-peel transition flex items-center"
                            }>
                            <svg
                                width="39"
                                height="33"
                        ...
                        <div
                            className={
                                router.pathname === "/settings"
                                    ? "text-orange-peel flex items-center"
                    ...
                    <Link href="/logout">
                        <div className="cursor-pointer hover:text-white transition flex items-center">
                            <svg
                                width="39"
                                height="33"
                                viewBox="0 0 37 41"
