...
export function AddToCalendar({ event }) {
  ...
  return (
    <>
      <button
        className="md:button-big xs:button-medium button-small button-deep-sky-blue flex items-center gap-2 rounded-[4.65px] md:text-20px xs:text-16px text-12px mx-auto sm:mx-0"
