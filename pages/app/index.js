        ...
        <DarkModeToggle
          ...
          {/* <div className="text-center md:mt-20 mt-[3rem]">
            ...
            <div className="mx-auto relative md:w-6/12 w-[100%] h-[15rem]">
              <Image src={placeholder} alt="" className="object-cover" layout="fill" width={700} height={430}/>
            </div>
          ...
          <div className="text-center md:mt-10 mt-20">
            <h1 className="font-semibold md:text-42px text-28px -mt-3">
              Hey there, <span className="text-fruit-salad">{name}.</span>
            </h1>
            <div className="mx-auto md:-mt-8 md:mb-0 mb-10">
              <Image src={placeholder} alt="" width={700} height={430} />
            </div>
            <div className="-mt-14 text-28px">
              <h1 className="md:text-54px -rotate-6">Welcome to</h1>
              <h1 className="md:text-54px font-semibold uppercase -mt-3">The Dynamics</h1>
