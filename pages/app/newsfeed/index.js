  ...
  return (
    <div className="xs:grid xs:grid-cols-12 dark:bg-[#202020]">
      ...
      <div className="mxs:flex mxs:flex-col mxs:justify-between mxs:px-0 mxs:pt-4 dark:bg-[#202020] dark:text-white col-span-11 p-10 pb-0 mx-auto content-center min-w-full">        
        ...
        <section className="w-[55rem] ml-[19rem]">          
        ...
        <section className="fixed right-0 top-[8rem]">
          <h3 className="mb-7 text-[23px]">Featured people</h3>

          <div className="bg-[#F8FBFF] rounded h-[max-content]">
            {
              people.map(person => {
                return (
                  ...
                  <button className={`justify-self-start border py-1 px-3 ml-9 rounded ${person.following ? "bg-deep-sky-blue text-white" : "bg-white"}`}>
