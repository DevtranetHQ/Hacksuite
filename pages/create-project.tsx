     ...
     return(
          <div className="dark:bg-[#202020] dark:text-white pl-3  pr-3 ">
               ...
               <header className="bg-[#F8FBFF] container-gray-dark dark:border-gray-dark py-14 px-6 xs:p-14 rounded-b-2xl text-center text-[30px]">
                    Here you can share all the cool things you're making and launching with <span className="font-bold">The Dynamics Community</span>, and beyond 
               </header>
               ...
               <form onSubmit={e => e.preventDefault()}>
                    ...
                    <div className="mt-7">
                         ...
                         <p className="font-bold text-[12px] font-italic">Tell us more about this project, a typical description talks about what it does, how it works, how it was built, some challenges encountered during the process, or future plans for it, 500 words max.</p>
                    </div>
                    ...
                    <div className="mt-7">
                         ...
                         <p className="font-bold text-[12px] font-italic">Tell us the team behind this amazing project, if it’s just you leave this section blank.</p>
                    </div>
                    ...
                    <div className="mt-7">
                         ...
                         <p className="font-bold text-[12px] font-italic">Select in order of relevance, the first four will be displayed on the project preview page. </p>
                    </div>
                    ...
                    <div className="mt-7">
                         ...
                         <p className="font-bold text-[12px] font-italic">Tell us about the current state of this project, e.g Beta, feature update, completed, bug fixes, etc.</p>
                    </div>
                    ...
                    <div className="mt-7">
                         ...
                         <div className="border-2 h-[200px] pt-10 pb-10 my-5 text-center rounded-md">
                              <div className="flex items-center gap-5 mt-2 mb-3 ml-5 text-18px"> <GithubIcon fill="black" height={"18px"} width="18px"/> <input type="text" placeholder="Github Link"/></div>      
                              <div className="flex items-center gap-5 mt-2 mb-3 ml-5 text-18px"> <FigmaIcon fill="black" height={"18px"} width="18px"/> <input type="text" placeholder="Figma Link"/></div>
                              <div className="flex items-center gap-5 mt-2 mb-3 ml-5 text-18px"> <AdobeIcon fill="black" height={"18px"} width="18px"/> <input type="text" placeholder="AdobeXD Link"/></div>
                              <div className="flex items-center gap-5 mt-2 mb-3 ml-5 text-18px"> <LinkIcon fill="black" height={"18px"} width="18px"/> <input type="text" placeholder="Other Links..."/></div>                                                  
                         </div>
