    ...
    <div className="">
      ...
      <div id="networking" className="mt-16">
        ...
        <div className="mt-9 py-20 rounded-bl-[20px] rounded-br-[20px] bg-[#F8FBFF] shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
          <p className="font-bold text-[24px] xs:text-48px lg:text-[66px] xl:text-[82px] 2xl:text-[90px] text-[#03A9F4] text-center mb-12">
          ...
          <div className="flex justify-center items-end">
            <div>
              ...
              <div className="flex">
                <input
                  className="text-10px xs:text-14px lg:text-18px xl:text-22px 2xl:text-24px rounded-bl-[10px] rounded-tl-[10px] border-[3px] border-[#03A9F4] py-4 md:py-6 px-2 xs:px-4 md:px-6"
                  placeholder="Developers, Angel Investors"
                />
                <div className="bg-[#FF9700] w-3"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  className="text-10px xs:text-14px lg:text-18px xl:text-22px 2xl:text-24px border-[3px] border-[#03A9F4] py-4 md:py-6 px-2 xs:px-4 md:px-6"
                  placeholder="Full-time Job, Investing"
                />
                <Link href="#">
                  <button className="px-2 xs:px-4 md:px-[1.39rem] flex items-center bg-[#03A9F4] rounded-br-[10px] rounded-tr-[10px] transition-all hover:scale-105 focus:scale-105">
                    <svg
                      width="35"
                      height="33"
                      viewBox="0 0 35 33"
