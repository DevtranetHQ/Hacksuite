                ...
                <div className="flex flex-col">
                    <section className="flex -mt-10">
                        ...
                        <div className="w-full xs:w-1/2 lg:w-1/3 2xl:w-1/4 sm:mx-0 md:mx-6 lg:mx-24 xl:mx-36 mt-10">
                            <h1 className="text-30px font-black mb-3 text-center">
                                LOG IN
                            </h1>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div className="flex justify-between">
                                            ...
                                            <a
                                                href="#"
                                                className="text-gray-500 text-12px font-bold pt-2"
                                            >
                                                Forgot Password?
                                            </a>
                                        </div>
                                    ...
                                    <button
                                        className="button-small button-deep-sky-blue mx-auto w-1/2 text-16px py-1 rounded mt-8"
                                        type="submit"
                                    >
                                        Log in
                                    </button>
                                    ...
                                    <a className="button-small button-deep-sky-blue mx-auto text-16px pl-8">
                                        The Dynamics Discord
                                        <Image src={Discord} height={24} />
                                    </a>
                                </div>
                            </form>
                        </div>
