...
export default function Login({ darkMode, toggleDarkMode }) {
    return (
        <div className="dark:bg-[#202020] dark:text-white flex flex-col min-h-screen">
            ...
            <div className="flex grow shrink basis-[auto] grid grid-cols-2">
                <div className="flex items-end relative">
                    <Image src={authImage} />
                </div>
                <div className="md:p-14">
                    <h1 className="eyebrow text-black text-center">Log In</h1>
                    <form>
                        <div>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <a
                                    href="#"
                                    className="text-gray-500 dark:text-white text-8px md:text-12px font-bold">
                                    Forgot Password?
                                </a>
                            </div>
                        ...
                        <button
                            className="button-small button-deep-sky-blue mx-auto"
                            type="submit">
                            Log in
                        </button>
                        ...
                        <a
                            href="#"
                            className="button-small button-deep-sky-blue flex gap-2">
                            <span>The Dynamics Discord</span>
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 71 55"
