  ...
  return (
    <div className="dark:bg-[#202020] dark:text-white">
      ...
      <header className="bg-[#F8FBFF] container-gray-dark border-b-4 dark:border-gray-dark p-14 rounded-b-2xl text-center">
        ...
        <h2 className="text-[16px] lg:lead mb-2 w-full mt-[16px] md:mt-[36px] md:mb-[28px]">
          A gallery of all the awesome things the makers at The Dynamics are building and launching
          everyday.
        </h2>
        <div className="inline-flex my-2 gap-x-4 mt-[20px]">
          ...
          <a
            className="button-small py-[15px] text-[16px] px-[15px] lg:button-medium button-deep-sky-blue inline-flex gap-x-2"
            href="#comments">
            Add your project
          </a>
        </div>
