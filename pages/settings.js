            ...
            <div className="col-span-10 p-10 relative">
                ...
                <button className="button-small button-deep-sky-blue flex gap-2">
                    <svg width="18" height="18" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.50016 15.6667V8.66667H0.833496L9.00016 0.5L17.1668 8.66667H12.5002V15.6667H5.50016ZM0.833496 20.3333V18H17.1668V20.3333H0.833496Z" fill="white"/>
                    </svg>
                    ...
                    <form className="bg-transparent pl-0">
                        ...
                        <div className="grid grid-cols-2 gap-10 mb-5">
                            <div>
                                ...
                                <input autoComplete="off" className="form-input" placeholder="John" id="firstName" type="text"/>
                            </div>
                            <div>
                                <label className="form-label" htmlFor="lastName">Last name</label>
                                <input autoComplete="off" className="form-input" placeholder="Doe" id="lastName" type="text"/>
                            </div>
                        </div>
                        <div className="mb-5">
                            <label className="form-label" htmlFor="email">Email address</label>
                            <input autoComplete="off" className="form-input" placeholder="johndoe@thedynamics.com" id="email" type="email"/>
                        </div>
                        <div className="mb-5">
                            <label className="form-label" htmlFor="phoneNumber">Phone number</label>
                            <input autoComplete="off" className="form-input" id="phoneNumber" type="tel"/>
                        </div>
                        <div className="grid grid-cols-2 gap-10 mb-5">
                            <div>
                                <label className="form-label" htmlFor="password">Password</label>
                                <input className="form-input" placeholder="*********" id="password" type="password"/>
                                <p className="caption xs mt-1.5">Leave blank if you don't want to change your password</p>
                            </div>
                            <div>
                                <label className="form-label" htmlFor="passwordConfirmation">Password confirmation</label>
                                <input className="form-input" placeholder="*********" id="passwordConfirmation" type="password"/>
                            </div>
                        </div>
