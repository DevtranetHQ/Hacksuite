...
export default function SampleWorkshop({ loggedIn, user }) {
  ...
  return (
    <div className="dark:bg-[#202020] dark:text-white">
      ...
      <section className="p-10 flex justify-between gap-x-5">
      ...
      <section className="p-10 mb-5">
        <h4 className="text-48px font-semibold mb-3">Lorem Ipsum</h4>
      ...
      <section className="p-10 mb-5">
        <pre>
          <code className="bg-transparent dark:bg-transparent">{code}</code>
        </pre>
      </section>
      <section className="p-10 mb-5">
        <h4 className="text-48px font-semibold mb-3">Lorem Ipsum</h4>
